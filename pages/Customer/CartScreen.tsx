    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            ...
            <Text style={styles.totalAmount}>$4.90</Text>
          </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.item}>
            <Image source={require('../../assets/image.png')} style={styles.itemImage} />
            <View style={styles.itemDetails}>
              <Text style={styles.itemName}>Iced Latte • Medium</Text>
              <Text style={styles.itemMods}>Whole milk • 50% sweet • Regular ice • Extra Shot</Text>
            </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryText}>$4.50</Text>
          </View>
          <View style={styles.summaryRow}>
            <Text style={styles.summaryText}>Taxes & fees</Text>
            <Text style={styles.summaryText}>$0.40</Text>
          </View>
          <View style={styles.summaryTotal}>
            <Text style={styles.summaryTotalText}>Total</Text>
            <Text style={styles.summaryTotalText}>$4.90</Text>
          </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.authMethod}>
            <View>
              <Text style={styles.authTitle}>Face ID</Text>
              <Text style={styles.authSubtitle}>Tap to authenticate with Face ID</Text>
            </View>
            <TouchableOpacity style={styles.useFaceIdButton}>
              <Text style={styles.useFaceIdButtonText}>Use Face ID</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={styles.payButton}>
          <Text style={styles.payButtonText}>Pay $4.90</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
